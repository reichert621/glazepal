...
You can configure your Instant app ID (`process.env.EXPO_PUBLIC_INSTANT_APP_ID`) in the `.env` file.

To get your own free app ID, visit [instantdb.com](https://instantdb.com)
